...
export default function HowThisWorks() {
  return (
    <>
      ...
      <p>
        No Nonsense is simply a series of lessons designed to give you all the
        essential information to make you the best fighting game player as fast
        as possible. Each section is a series of lessons that are placed in the
        order that you should view them. While I don't think it would be the end
        of the world if you were to take them out of order, I strongly suggest
        you view them in the order presented, as there is a purpose behind when
      ...
      <p>
        ...
        anyone would hold my opinion in such high regard. Good luck and have
        fun!
      </p>
    </>
  );
