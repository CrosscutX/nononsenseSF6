  ...
  return (
    <div className="intro">
      <blockquote>
        ...
        <footer className="author">-Tokido</footer>
      </blockquote>
      <p>
        Fighting games are one of the most compelling genres of games out there.
        There are few games that can match the thrill and excitement that comes
        from a tense back and forth tournament set where any small mistake could
        mean disaster. Fighting games have allowed me to connect with friends
