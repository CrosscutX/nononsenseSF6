...
export default function What() {
  return (
    <div className="what">
      <h2>What is this?</h2>
      <p>
        This site is a collection lessons and resources designed to turn you
        into a strong fighting game player as quickly as possible. With so many
        fighting game concepts, it can be difficult to know what you should be
